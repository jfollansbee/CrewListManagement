...
function tc_setDay(objname, dvalue, path){
	...
	if(isDate(dvalue, date_array[1], date_array[0])){
		...
		var dp = document.getElementById(objname+'_dp');
		
		obj.src = path+"calendar_form.php?objname="+objname.toString()+"&selected_day="+dvalue+"&selected_month="+date_array[1]+"&selected_year="+date_array[0]+"&year_start="+year_start+"&year_end="+year_end+"&dp="+dp;
...
function tc_setMonth(objname, mvalue, path){
	...
	if(isDate(date_array[2], mvalue, date_array[0])){
		...
		obj.src = path+"calendar_form.php?objname="+objname.toString()+"&selected_day="+date_array[2]+"&selected_month="+mvalue+"&selected_year="+date_array[0]+"&year_start="+year_start+"&year_end="+year_end+"&dp="+dp;
...
function tc_setYear(objname, yvalue, path){
	...
	if(isDate(date_array[2], date_array[1], yvalue)){
		...
		obj.src = path+"calendar_form.php?objname="+objname.toString()+"&selected_day="+date_array[2]+"&selected_month="+date_array[1]+"&selected_year="+yvalue+"&year_start="+year_start+"&year_end="+year_end+"&dp="+dp;
